...
public class DbHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        // Bảng Thành Viên
        String dbTableThanhVien = "CREATE TABLE THANHVIEN (MATV INTEGER PRIMARY KEY AUTOINCREMENT, HOTEN TEXT NOT NULL, NAMSINH TEXT NOT NULL)";
        ...
        db.execSQL("INSERT INTO THANHVIEN VALUES (1, 'Nguễn Văn Trà' , '2000'), (2, 'Nguyễn Thị Hồng', '1998')");
